...
const classes: Record<string, Record<string, boolean>> = {
  ...
  colorpicker__swatch: {
    ...
    'data-[active=true]:after:bg-surface-container-lowest': true,
  ...
  datepicker__month: {
    ...
    'focus:bg-surface-container-lowest': true,
  ...
  slider__mark: {
    ...
    '-translate-y-1/2': true,
    'bg-surface-container-highest': true,
    'data-[active=true]:bg-surface-container-lowest': true,
  },
  slider__markLabel: {
    absolute: true,
  ...
  'multi-step__tab': {
    ...
    'group-data-[tab-style=tab]/wrapper:data-[active=true]:bg-surface-container-lowest': true,
    ...
    'group-data-[tab-style=progress]/wrapper:before:bg-surface-container-lowest': true,
